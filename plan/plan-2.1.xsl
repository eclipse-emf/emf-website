...
<xsl:for-each select="plan">
	...
	<head>
    <title>Eclipse Tools - EMF, SDO and XSD - Development Plan 2.1</title>
  ...
  <tbody>
    ...
    <tr>
      <td align="left" width="60%">
        <font class="indextop">
		Development Plan 2.1<xsl:if test="$product!='' or $version!=''">:
...
<!-- $Id: plan-2.1.xsl,v 1.1 2005/07/15 16:30:37 elena Exp $ -->