<?php
	...
	$rooturl = "http://www.eclipse.org/emf";
	...
	$Nav->addNavSeparator("Downloads", "$downurl/emf/downloads/");
	...
	$Nav->addCustomNav("Release Notes", "$rooturl/news/release-notes.php", "_self", 2);
