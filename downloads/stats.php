...
if ($qsvars["filenames"] && !is_array($qsvars["filenames"])) { 
	...
	if ($qsvars["uml2"]) { // for UML2 numbers use these default queries
...
$qsvars["generator"] = '$Id: stats.php,v 1.98 2007/04/17 21:05:35 nickb Exp $';
...
function doQuery($sql,$isCSV=false) {
    ...
    if(mysql_errno($dbh) > 0) {
		...
		echo "<p align=\"right\"><small>\n".
			 '$Id: stats.php,v 1.98 2007/04/17 21:05:35 nickb Exp $'.
			 "\n</small></p>\n";
		echo "</data>\n";
		exit;
    }
